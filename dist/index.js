!(function(e, r) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? (exports["pf2-web-ui"] = r(require("react")))
        : (e["pf2-web-ui"] = r(e.React));
})(window, function(e) {
    return (function(e) {
        var r = {};
        function o(n) {
...
*/ !(function() {
        ...
        function(e, r, o) {
            ...
            function u(e, r) {
                for (var o = {}, n = [], t = 0; t < e.length; t++) {
                    ...
                    -1 !== l ? (c[l].references++, c[l].updater(d)) : c.push({ identifier: s, updater: v(d, r), references: 1 }),
                        n.push(s);
                }
                return n;
            }
            ...
            var s,
                l =
                    ((s = []),
                    function(e, r) {
                        return (s[e] = r), s.filter(Boolean).join("\n");
                    });
            function d(e, r, o, n) {
                var t = o ? "" : n.media ? "@media ".concat(n.media, " {").concat(n.css, "}") : n.css;
                if (e.styleSheet) e.styleSheet.cssText = l(r, t);
                else {
                    var a = document.createTextNode(t),
                        c = e.childNodes;
                    c[r] && e.removeChild(c[r]), c.length ? e.insertBefore(a, c[r]) : e.appendChild(a);
                }
            }
            function p(e, r, o) {
                var n = o.css,
            ...
            function v(e, r) {
                ...
                if (r.singleton) {
                    var a = h++;
                    (o = b || (b = f(r))), (n = d.bind(null, o, a, !1)), (t = d.bind(null, o, a, !0));
                } else
                    (o = f(r)),
                        (n = p.bind(null, o, r)),
                        (t = function() {
            ...
            e.exports = function(e, r) {
                (r = r || {}).singleton || "boolean" == typeof r.singleton || (r.singleton = t());
                var o = u((e = e || []), r);
                return function(e) {
                    if (((e = e || []), "[object Array]" === Object.prototype.toString.call(e))) {
                        ...
                        for (var a = u(e, r), f = 0; f < o.length; f++) {
                            var s = i(o[f]);
                ...
                return (
                    ...
                    (r.i = function(e, o, n) {
                        ...
                        for (var i = 0; i < e.length; i++) {
                            var u = [].concat(e[i]);
                            (n && t[u[0]]) || (o && (u[2] ? (u[2] = "".concat(o, " and ").concat(u[2])) : (u[2] = o)), r.push(u));
                        }
                    }),
                    r
                );
        ...
        function(e, r, o) {
            ...
            var n = o(1),
                ...
                u = o.n(i);
            o(5);
            var f = { PRIMARY: "primary", SECONDARY: "secondary", IMPORTANT: "important" },
                s = function(e) {
                    return t.a.createElement(
                        "button",
                        {
                            className: u()(
                                ((r = { "custom-button": "custom" === e.type, "unistar-button": "custom" !== e.type }),
                                (o = Object.values(f).indexOf(e.type) >= 0 ? e.type : f.STANDARD),
                                (n = !0),
                                o in r
                                    ? Object.defineProperty(r, o, { value: n, enumerable: !0, configurable: !0, writable: !0 })
                                    : (r[o] = n),
                                r),
                                e.className
                            ),
            ...
            (s.propTypes = {
                ...
                type: c.a.oneOf(["custom", f.PRIMARY, f.SECONDARY, f.IMPORTANT]),
                disabled: c.a.bool,
                onClick: c.a.func,
            }),
                (s.defaultProps = {
