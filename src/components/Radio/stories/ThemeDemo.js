        ...
        <Form>
            <Form.Row>
                <Form.Item label={`small size:`}>
                    <Radio.Group size={`small`} value={smallValue} onChange={e => setSmallValue(e.target.value)} theme={`early`}>
            ...
            <Form.Row>
                <Form.Item label={`big size:`}>
                    <Radio.Group value={bigValue} onChange={e => setBigValue(e.target.value)} theme={`night`}>
